code = open(string(Base.source_path()[1:(end-8)],"kepler.c")) do f
    code = readstring(f)
end
...
cKeplerFlow!(x_bek::Array{Float64,1}, v_bek::Array{Float64,1}, x0_bek::Array{Float64,1}, v0_bek::Array{Float64,1}, i::Any, mu::Float64, traza::Int32) = 
    ccall(("kepler", Clib), Void,(Ptr{Float64},Ptr{Float64},Ptr{Float64},Ptr{Float64},Float64,Float64,Int32), 
    x_bek, v_bek, x0_bek, v0_bek, convert(Float64,i), mu, traza)
